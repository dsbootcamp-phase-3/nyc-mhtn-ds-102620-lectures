...
## Fork the repository at https://github.com/learn-co-students/nyc-mhtn-ds-102620-lectures
...
```
git remote add upstream https://github.com/learn-co-students/nyc-mhtn-ds-102620-lectures.git
```
